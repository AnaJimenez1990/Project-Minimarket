...
/****** Object:  Database [MINISUPER]    Script Date: 13/06/2016 07:29:13 p.m. ******/
CREATE DATABASE [MINISUPER]
 CONTAINMENT = NONE
 ON  PRIMARY 
( NAME = N'MINISUPER', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL11.MSSQLSERVER\MSSQL\DATA\MINISUPER.mdf' , SIZE = 5120KB , MAXSIZE = UNLIMITED, FILEGROWTH = 1024KB )
 LOG ON 
( NAME = N'MINISUPER_log', FILENAME = N'C:\Program Files\Microsoft SQL Server\MSSQL11.MSSQLSERVER\MSSQL\DATA\MINISUPER_log.ldf' , SIZE = 2048KB , MAXSIZE = 2048GB , FILEGROWTH = 10%)
GO
...
ALTER DATABASE [MINISUPER] SET AUTO_CLOSE OFF 
GO
...
ALTER DATABASE [MINISUPER] SET  DISABLE_BROKER 
GO
...
ALTER DATABASE [MINISUPER] SET RECOVERY FULL 
GO
